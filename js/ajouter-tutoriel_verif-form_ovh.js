...
{
    if(document.getElementById("difficulte").value=="0")
    {
      document.getElementById("votex").style.backgroundColor="#fba";
      return false;
    }
   else
   {
...
{
    if(document.getElementById("difficulte2").value=="0")
    {
...
function verifForm(f)
{
   ...
   if(titreOk && dechetOk && img_princOk && difficulteOK && introOK && materielOK && titre_etape1OK && img_etape1OK && tutoriel_etape1OK && categorieOK && motcleOK && sourceOK)
   {
     return true;
